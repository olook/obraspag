...
.with_customer_address(address).with_delivery_address(address)

request = Braspag::AuthorizeTransactionRequestBuilder.new.with_request_id("00000000-0000-0000-0000-000000000007")
.for_order(order).for_customer(customer).with_payment_request().build
