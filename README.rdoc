...
Method Capture
    ...
    request = Braspag::CaptureCreditCardTransactionRequestBuilder
...
Method Void
    ...
    request = Braspag::VoidCreditCardTransactionRequestBuilder.new
    .with_request_id("00000000-0000-0000-0000-000000000009")
    .with_transaction_data_collection(ta).build
